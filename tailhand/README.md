...
本协作仓库已将官方 Python SDK 的已核对提交 `fbec1057` 展开到项目目录，不需要额外初始化子模块：

```bash
git clone --branch codex/linkerhand-o6-recamera-auto-grasp \
  https://github.com/tree1129/HK_hackathon_physical_ai_we_tail.git
cd HK_hackathon_physical_ai_we_tail/tailhand/apps/o6-camera-teleop
python3 -m venv .venv
